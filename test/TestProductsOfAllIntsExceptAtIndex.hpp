...
TEST(TestGetProductsOfAllIntsExceptAtIndex, small_vector) {
  const auto actual =
      interview_cake::ProductsOfAllIntsExceptAtIndex({2, 4, 10});
  const auto expected = std::vector<int>{40, 20, 8};
  ASSERT_EQ(actual, expected);
}

TEST(TestGetProductsOfAllIntsExceptAtIndex, small_vector2) {
  const auto actual = interview_cake::ProductsOfAllIntsExceptAtIndex({1, 2, 3});
...
TEST(TestGetProductsOfAllIntsExceptAtIndex, longer_vector) {
  const auto actual =
      interview_cake::ProductsOfAllIntsExceptAtIndex({8, 2, 4, 3, 1, 5});
...
TEST(TestGetProductsOfAllIntsExceptAtIndex, vector_has_one_zero) {
  const auto actual =
      interview_cake::ProductsOfAllIntsExceptAtIndex({6, 2, 0, 3});
...
TEST(TestGetProductsOfAllIntsExceptAtIndex, vector_has_two_zeros) {
  const auto actual =
      interview_cake::ProductsOfAllIntsExceptAtIndex({4, 0, 9, 1, 0});
...
TEST(TestGetProductsOfAllIntsExceptAtIndex, one_negative_number) {
  const auto actual =
      interview_cake::ProductsOfAllIntsExceptAtIndex({-3, 8, 4});
